...
from _helper_functions import get_all_cell_combinations
...
def transform_individual_ascii_map(individual, modelfolder=False, ind_number=0, map_info=None, patchID_map_info=None, header_all_info=None, feasible=True):
    ...
    # Uncomment when using the preprocessing layer
    # # Get all cell combinations from the new individual and add them in new ascii file
    # cell_combinatinations = get_all_cell_combinations(ascii_map)
    # WriteMap([], cell_combinatinations, modelfolder, ind_number, feasible, map_postprocess=True)
